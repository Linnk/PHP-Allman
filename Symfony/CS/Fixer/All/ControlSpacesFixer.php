...
class ControlSpacesFixer implements FixerInterface
{
    ...
    public function fix(\SplFileInfo $file, $content)
    {
		...
		$content = $this->fixControlsWithParenthesesWithoutSuffixBrace($content);
        $content = $this->fixControlsWithPrefixBraceWithoudSuffixBrace($content);
     ...
     * @return string
     */
    private function fixControlsWithParenthesesWithoutSuffixBrace($content)
    {
        $statements = array(
            'if',
            'for',
     ...
     * @return string
     */
    private function fixControlsWithPrefixBraceWithoudSuffixBrace($content)
    {
        $statements = array(
            'else',
        );
